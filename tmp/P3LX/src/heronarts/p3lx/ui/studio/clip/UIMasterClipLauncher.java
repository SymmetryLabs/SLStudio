...
public class UIMasterClipLauncher extends UIClipLauncher {
    ...
    public UIMasterClipLauncher(UI ui, UIMixer mixer, LX lx) {
        ...
        for (int i = 0; i < NUM_CLIPS; ++i) {
            this.mutableClips.add((UIMasterClipButton) new UIMasterClipButton(ui, mixer, lx, i, 0, i * UIClipButton.HEIGHT).addToContainer(this));
        }
        new UIMasterClipStop(ui, lx).addToContainer(this);
    }
