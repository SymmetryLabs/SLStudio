...
namespace ImGui
{
    ...
    // Custom Symmetry-created widgets
    // Keep these separate from other ImGui things for easy merging in the future.
    IMGUI_API bool Knob(const char *label, float *v, float min, float max);
