public class Sun5FrontTopPixliteConfig {
  public Sun5FrontTopPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("10")
        ...
        .addPoints(slice.getStripById("52").points) // 2
    ));
...
public class Sun5BackTopPixliteConfig {
  public Sun5BackTopPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("1")
        ...
        .addPoints(slice.getStripById("10").points)
        .addPoints(slice.getStripById("11").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice.getStripById("12").points, PointsGrouping.Shift.LEFT) // 2
    ));
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("10")
        ...
        .addPoints(slice.getStripById("50").points)
        .addPoints(slice.getStripById("51").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice.getStripById("52").points, PointsGrouping.Shift.LEFT) // 2
    ));
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("11")
        .addPoints(slice.getStripById("53").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice.getStripById("54").points)
        .addPoints(slice.getStripById("55").points, PointsGrouping.REVERSE_ORDERING, PointsGrouping.Shift.LEFT) // 2
        .addPoints(slice.getStripById("56").points, PointsGrouping.Shift.RIGHT) // 2
    ));
