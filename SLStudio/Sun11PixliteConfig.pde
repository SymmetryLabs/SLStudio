public class Sun11FrontTopPixliteConfig {
  public Sun11FrontTopPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
...
public class Sun11BackTopPixliteConfig {
  public Sun11BackTopPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
...
public class Sun11BackBottomPixliteConfig {
  public Sun11BackBottomPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("4")
        .addPoints(slice.getStripById("24").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice.getStripById("25").points, PointsGrouping.Shift.RIGHT)
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("6")
        ...
        .addPoints(slice.getStripById("35").points, PointsGrouping.REVERSE_ORDERING, PointsGrouping.Shift.LEFT)
        .addPoints(slice.getStripById("36").points)
    ));
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("8")
        .addPoints(slice.getStripById("41").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice.getStripById("42").points)
        .addPoints(slice.getStripById("43").points, PointsGrouping.REVERSE_ORDERING, PointsGrouping.Shift.LEFT)
        .addPoints(slice.getStripById("44").points)
    ));
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("13")
        .addPoints(slice.getStripById("60").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice.getStripById("61").points, PointsGrouping.Shift.RIGHT)
        .addPoints(slice.getStripById("62").points, PointsGrouping.REVERSE_ORDERING)
    ));
