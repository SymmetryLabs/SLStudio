package com.symmetrylabs.comments;// //----------------------------------------------------------------------------------------------------------------------------------
...
//     dTurn   t0, t1, t2, t3;
//     com.symmetrylabs.model.Strip   s;
//     int     dir, ci;        // dir -- 1 or -1.
//                             // ci  -- color index

//     dVertex(com.symmetrylabs.model.Strip _s, LXPoint _p)  { s = _s; ci  = _p.index; }
...
//                                                                 }
//     float   dist2    (com.symmetrylabs.model.Strip s1, int pos1, com.symmetrylabs.model.Strip s2, int pos2)   {   return pointDist(s1.points.get(pos1), s2.points.get(pos2)); }
//     float   pd2      (LXPoint p1, float x, float y, float z)        {   return dist(p1.x,p1.y,p1.z,x,y,z); }
//     boolean sameSame (com.symmetrylabs.model.Strip s1, com.symmetrylabs.model.Strip s2)                       {   return max(dist2(s1, 0, s2, 0), dist2(s1,14, s2,14)) < 5 ;  }   // same strut, same direction
//     boolean sameOpp  (com.symmetrylabs.model.Strip s1, com.symmetrylabs.model.Strip s2)                       {   return max(dist2(s1, 0, s2,14), dist2(s1,14, s2,0 )) < 5 ;  }   // same strut, opp direction
//     boolean sameBar  (com.symmetrylabs.model.Strip s1, com.symmetrylabs.model.Strip s2)                       {   return sameSame(s1,s2) || sameOpp(s1,s2);                   }   // 2 strips on same strut
...
//     dVertex v0(com.symmetrylabs.model.Strip s) { return (dVertex)s.obj1; }
//     dVertex v1(com.symmetrylabs.model.Strip s) { return (dVertex)s.obj2; }

//     dPixel getClosest(PVector p) {
//         dVertex v = null; int pos=0; float d = 2500;

//         for (com.symmetrylabs.model.Strip s : model.strips) {
...
//         for (com.symmetrylabs.model.Strip s1 : model.strips) { for (com.symmetrylabs.model.Strip s2 : model.strips) {
