...
public class FultonStreetLayout {
    ...
    public FultonStreetLayout() {
        ...
        // Note: y values are set in com.symmetrylabs.model.Sun class by type
    ...
    public static SLModel buildModel() {
        ...
        transform.rotateX(globalRotationX * PI / 180f);
        transform.rotateY(globalRotationY * PI / 180f);
        transform.rotateZ(globalRotationZ * PI / 180f);
