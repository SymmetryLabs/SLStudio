...
public class BlobTracker extends LXModulatorComponent implements LXOscListener, com.symmetrylabs.util.MarkerSource {
    ...
    public Collection<com.symmetrylabs.util.Marker> getMarkers() {
        ...
        for (Blob blob : lastKnownBlobs) {
            markers.add(new com.symmetrylabs.util.OctahedronWithArrow(blob.pos, 12, 0xff0080, blob.vel, 0x8000ff));
        }
        return markers;
    }
