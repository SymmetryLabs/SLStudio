...
import com.symmetrylabs.mappings.FultonStreetLayout;
...
import com.symmetrylabs.performance.APC40Listener;
import com.symmetrylabs.performance.FoxListener;
import com.symmetrylabs.performance.PerformanceManager;
import com.symmetrylabs.pixlites.Pixlite;
import com.symmetrylabs.ui.UISpeed;
...
public class SLStudio extends PApplet {
    ...
    /*
    pl.set("cities.london", new com.symmetrylabs.palettes.DeckChairSource("5568230b7b2853502527fd4e"), new com.symmetrylabs.palettes.ArcPaletteExtractor(0.44, 100));
    pl.set("cities.paris", new com.symmetrylabs.palettes.DeckChairSource("5568862a7b28535025280c72"), new com.symmetrylabs.palettes.ArcPaletteExtractor(0.46, 100));
    pl.set("cities.sydney", new com.symmetrylabs.palettes.DeckChairSource("599d6375096641f2272bacf4"), new com.symmetrylabs.palettes.ArcPaletteExtractor(1, 100));
    pl.set("cities.san_francisco", new com.symmetrylabs.palettes.UrlImageSource("http://icons.wunderground.com/webcamramdisk/a/m/ampledata/1/current.jpg"), new com.symmetrylabs.palettes.ArcPaletteExtractor(0.65, 100));
    pl.set("sunsets.sunset", new com.symmetrylabs.palettes.UrlImageSource("https://pbs.twimg.com/media/DO9Ok2JU8AEjXa1.jpg"), new com.symmetrylabs.palettes.ArcPaletteExtractor(0.622, 100));
    pl.set("sunsets.orange", new com.symmetrylabs.palettes.UrlImageSource("https://c.pxhere.com/photos/0e/29/sunrise_beach_sea_ocean_water_sunset_sky_sun-1332581.jpg!d"), new com.symmetrylabs.palettes.ArcPaletteExtractor(0.5, 100));
    */
    ...
    Pixlite[] setupPixlites(LX lx) {
        ...
        Pixlite[] pixlites = new Pixlite[]{
            // com.symmetrylabs.model.Sun 1 (One Third)
            ...
            // com.symmetrylabs.model.Sun 7 (Two Thirds)
            new Pixlite(lx, "10.200.1.33", ((SLModel) lx.model).getSliceById("sun7_top_front")),
            // locked
            new Pixlite(lx, "10.200.1.34", ((SLModel) lx.model).getSliceById("sun7_bottom_front")),
            // locked
            new Pixlite(lx, "10.200.1.31", ((SLModel) lx.model).getSliceById("sun7_top_back")),
            // locked
            new Pixlite(lx, "10.200.1.32", ((SLModel) lx.model).getSliceById("sun7_bottom_back")),
            // locked

            // com.symmetrylabs.model.Sun 8 (Two Thirds)
            new Pixlite(lx, "10.200.1.27", ((SLModel) lx.model).getSliceById("sun8_top_front")),
            // locked
            new Pixlite(lx, "10.200.1.28", ((SLModel) lx.model).getSliceById("sun8_bottom_front")),
            // locked
            new Pixlite(lx, "10.200.1.29", ((SLModel) lx.model).getSliceById("sun8_top_back")),
            // trimmed
            new Pixlite(lx, "10.200.1.30", ((SLModel) lx.model).getSliceById("sun8_bottom_back")),
            // trimmed

            // com.symmetrylabs.model.Sun 9 (Full)
            ...
            // com.symmetrylabs.model.Sun 10 (Full)
            ...
            // locked
            new Pixlite(lx, "10.200.1.21", ((SLModel) lx.model).getSliceById("sun10_top_back")),
            ...
            // sun 11
            // new Pixlite(lx, "10.200.1.xx", ((com.symmetrylabs.model.SLModel)lx.model).getSliceById("sun11_top_front")),
            // new Pixlite(lx, "10.200.1.xx", ((com.symmetrylabs.model.SLModel)lx.model).getSliceById("sun11_bottom_front")),
            // new Pixlite(lx, "10.200.1.xx", ((com.symmetrylabs.model.SLModel)lx.model).getSliceById("sun11_top_back")), // locked
            // new Pixlite(lx, "10.200.1.xx", ((com.symmetrylabs.model.SLModel)lx.model).getSliceById("sun11_bottom_back")), // locked
        };
