...
public SLModel buildModel() {
  ...
  //        9,  25,  35,  43,  49,  55,  59,  65,  69,  73,  //  1 - 10
  //       77,  81,  85,  89,  91,  95,  97, 101, 103, 107,  // 11 - 20
  //       09, 111, 113, 115, 119, 121, 123, 125, 127, 129,  // 21 - 30
  //       29, 131, 133, 135, 137, 137, 139, 141, 141, 143,  // 31 - 40
  //       45, 145, 147, 147, 149, 149, 151, 151, 154, 154,  // 41 - 50
  //       54, 155, 155, 155, 157, 157, 157, 157, 159, 159,  // 51 - 60
  //       59, 159, 159, 161, 161, 161, 161, 161, 161        // 61 - 69
  //     }
  //   }
  // ));
  ...
  suns.add(new Sun("sun6", Sun.Type.TWO_THIRDS, new float[] {0, 0, 0}, new float[] {0, 0, 0}, transform, 
    new int[][] {
      { // Top - Front (NOT FINAL)
         ...
         77,  81,  85,  89,  91,  95,  97, 101, 103, 107,  // 11 - 20
        109, 111, 113, 115, 119, 121, 123, 125, 127, 129,  // 21 - 30
        129, 131, 133, 135, 137, 136, 138, 141, 141, 143,  // 31 - 40
        145, 145, 147, 147, 149, 149, 151, 151, 154, 153,  // 41 - 50
        155, 155, 155, 155, 157, 157, 155, 157, 159, 159,  // 51 - 60
        159, 159, 159, 161, 161, 161, 161, 161, 161        // 61 - 69
      },
      { // Bottom - Front (NOT FINAL)
        149, 151, 151, 153, 153,                           // 46 - 50
        153, 155, 155, 155, 157, 157, 157, 157, 159, 159,  // 51 - 60
        159, 159, 159, 161, 161, 161, 161                  // 61 - 67
      },
      { // Top - Back
          9,  25,  35,  43,  49,  55,  59,  65,  69,  73,  //  1 - 10
         77,  81,  85,  89,  91,  95,  97, 101, 103, 107,  // 11 - 20
      ...
      { // Bottom - Back
        149, 151, 151, 153, 153,                           // 46 - 50
        154, 154, 155, 155, 157, 157, 155, 157, 159, 159,  // 51 - 60
        159, 159, 159, 161, 161, 161, 161                  // 61 - 67
      },
    }
  ));
