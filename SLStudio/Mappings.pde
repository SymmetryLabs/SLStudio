...
public SLModel buildModel() {
  ...
  // outside
  wickets.add(new Wicket("A", "10.200.1.14", Wicket.Type.INSIDE, new float[] {0, 0,  0*FEET}, new float[] {0, 0, 0}, transform));

  // building 1
  wickets.add(new Wicket("B", "10.200.1.15", Wicket.Type.INSIDE, new float[] {0, 0,  28*FEET}, new float[] {0, 0, 0}, transform));
  wickets.add(new Wicket("C", "10.200.1.10", Wicket.Type.INSIDE, new float[] {0, 0,  43*FEET}, new float[] {0, 0, 0}, transform));

  // outside
  wickets.add(new Wicket("D", "10.200.1.11", Wicket.Type.INSIDE, new float[] {0, 0, 72*FEET}, new float[] {0, 0, 0}, transform));
  wickets.add(new Wicket("E", "10.200.1.12", Wicket.Type.INSIDE, new float[] {0, 0, 83*FEET}, new float[] {0, 0, 0}, transform));
  
  // building 2
  wickets.add(new Wicket("F", "10.200.1.13", Wicket.Type.INSIDE, new float[] {0, 0, 106*FEET}, new float[] {0, 0, 0}, transform));
  wickets.add(new Wicket("G", "10.200.1.17", Wicket.Type.INSIDE, new float[] {0, 0, 122*FEET}, new float[] {0, 0, 0}, transform));

  // outside
  wickets.add(new Wicket("H", "10.200.1.18", Wicket.Type.INSIDE, new float[] {0, 0, 147*FEET}, new float[] {0, 0, 0}, transform));
  ...
  // outside
  wickets.add(new Wicket("M", "10.200.1.23", Wicket.Type.INSIDE, new float[] {0, 0, 237*FEET}, new float[] {0, 0, 0}, transform));
  wickets.add(new Wicket("N", "10.200.1.16", Wicket.Type.INSIDE, new float[] {0, 0, 248*FEET}, new float[] {0, 180, 0}, transform)); //

  // building 4
  wickets.add(new Wicket("O", "10.200.1.24", Wicket.Type.INSIDE, new float[] {0, 0, 276*FEET}, new float[] {0, 0, 0}, transform)); //
  wickets.add(new Wicket("P", "10.200.1.25", Wicket.Type.INSIDE, new float[] {0, 0, 287*FEET}, new float[] {0, 0, 0}, transform)); //

  // outside
  wickets.add(new Wicket("Q", "10.200.1.26", Wicket.Type.INSIDE, new float[] {0, 0, 311*FEET}, new float[] {0, 0, 0}, transform)); //
  wickets.add(new Wicket("R", "10.200.1.27", Wicket.Type.INSIDE, new float[] {0, 0, 321*FEET}, new float[] {0, 180, 0}, transform)); //
  wickets.add(new Wicket("J", "10.200.1.28", Wicket.Type.INSIDE, new float[] {0, 0, 331*FEET}, new float[] {0, 180, 0}, transform)); //
