...
public class TestGraphicsPattern extends LXPattern {

  PGraphics pg;

  public TestGraphicsPattern(LX lx) {
    super(lx);
    pg = applet.createGraphics(1, 100, P3D);
  }
  ...
  public void run(double deltaMs) {
    ...
    for (int i = 0; i < pg.pixels.length; ++i) {
      this.colors[model.points[i].index] = pg.pixels[i];
    }
  }
}
