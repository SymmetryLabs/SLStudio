...
public class Sun7BackBottomPixliteConfig {
  public Sun7BackBottomPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
    ...
    Slice slice_with_model = ((SLModel)lx.model).getSliceById("sun7_top_back");
    pixlite.addChild(new PixliteOutput(lx, ipAddress,
      new PointsGrouping("2")
        .addPoints(slice_with_model.getStripById("1").points,  PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice_with_model.getStripById("2").points)
        .addPoints(slice_with_model.getStripById("3").points,  PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice_with_model.getStripById("4").points)
        .addPoints(slice_with_model.getStripById("5").points,  PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice_with_model.getStripById("6").points)
        .addPoints(slice_with_model.getStripById("7").points,  PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice_with_model.getStripById("8").points)
        .addPoints(slice_with_model.getStripById("9").points,  PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice_with_model.getStripById("10").points)
        .addPoints(slice_with_model.getStripById("11").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(slice_with_model.getStripById("12").points)
    ));
  }
}
