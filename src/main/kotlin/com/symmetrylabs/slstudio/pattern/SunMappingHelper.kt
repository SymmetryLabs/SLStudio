...
//import com.symmetrylabs.util.DistanceConstants.*
...
//
//    val mappings = FultonStreetLayout.mappings
//
...
//			val previousStripLength = FultonStreetLayout.stripLength(selectedStrip)
...
//					break
//				}
//				val previousNextStripLength = FultonStreetLayout.stripLength(nextStrip)
...
//		stripLength.value = FultonStreetLayout.stripLength(selectedStrip).toDouble()
//	}
//
