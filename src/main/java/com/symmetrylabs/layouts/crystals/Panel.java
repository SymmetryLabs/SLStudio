...
public class Panel extends SLModel {
    ...
    public Panel(String id, float x, float y, float z, float rx, float ry, float rz, float[][] stringLengths, LXTransform t) {
...
//      private final List<LXPoint> points = new ArrayList<>();
        ...
        public Fixture(String id, float x, float y, float z, float rx, float ry, float rz, float[][] stringLengths, LXTransform t) {
            float SUBPANEL_LENGTH = 14.6666666f;

            this.id = id;
            float[] invert = {-1.0f, -1.0f, -1.0f};
