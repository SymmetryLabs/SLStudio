...
public class UITreeGround extends UI3dComponent {
    ...
    protected void onDraw(heronarts.p3lx.ui.UI ui, PGraphics pg) {
        ...
        pg.vertex(-100*FEET, -OfficeTreeModel.LIMB_HEIGHT - 1*FEET, -100*FEET, 0, 0);
        pg.vertex(100*FEET, -OfficeTreeModel.LIMB_HEIGHT - 1*FEET, -100*FEET, 0, 1);
        pg.vertex(100*FEET, -OfficeTreeModel.LIMB_HEIGHT - 1*FEET, 100*FEET, 1, 1);
        pg.vertex(-100*FEET, -OfficeTreeModel.LIMB_HEIGHT - 1*FEET, 100*FEET, 1, 0);
        pg.endShape(CLOSE);

        float personY = -OfficeTreeModel.LIMB_HEIGHT - 1*FEET;
