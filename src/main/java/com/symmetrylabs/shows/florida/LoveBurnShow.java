package com.symmetrylabs.shows.loveburn;
...
public class LoveBurnShow extends CubesShow implements HasWorkspace {
    public static final String SHOW_NAME = "loveburnshow";
...
// Back Row Middle
    ...
    public void setupUi(SLStudioLX lx, SLStudioLX.UI ui) {
        super.setupUi(lx, ui);
        workspace = new Workspace(lx, ui, "shows/loveburn");
    }
