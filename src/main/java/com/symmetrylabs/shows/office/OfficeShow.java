...
public class OfficeShow extends CubesShow implements Show {
    ...
    static final TowerConfig[] TOWER_CONFIG = {
        ...
        new TowerConfig(diag * -.5f, 0, diag * .5f,  0, cuberotation, 0, new String[] { "420", "211" }),
        new TowerConfig(diag * .5f,  0, diag * .5f,  0, cuberotation, 0, new String[] { "408", "157" }),
        new TowerConfig(diag * 1.5f, 0, diag * .5f,  0, cuberotation, 0, new String[] { "22", "198" }),
        new TowerConfig(diag * 2.5f, 0, diag * .5f,  0, cuberotation, 0, new String[] { "86", "314" }),
        new TowerConfig(diag * 0,    0, diag * 1.5f, 0, cuberotation, 0, new String[] { "34" }),
        new TowerConfig(diag * 1,    0, diag * 1.5f, 0, cuberotation, 0, new String[] { "32" }),
        new TowerConfig(diag * 2,    0, diag * 1.5f, 0, cuberotation, 0, new String[] { "51" }),
    };
