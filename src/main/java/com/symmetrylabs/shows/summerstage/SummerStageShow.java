        ...
        */
        new ClusterConfig("LEFT_FACE",SP*0, SP*1, SP*2, new TowerConfig[]{
            ...
            new TowerConfig(SP * 11, SP * 3, SP * 0, new String[][]{
                new String[]{"926", "998"}, new String[]{"516", "1101"}, new String[]{"935", "999"}
            }),
            ...
            new TowerConfig(SP * 11, SP * 10, SP * 0, new String[][]{
                new String[]{"981", "982"}, new String[]{"1003", "989"}, new String[]{"673", "1071"}, new String[]{"817", "682"}
            }),
            // col 12 (-1)
        ...
        */
        new ClusterConfig("RIGHT_FACE",SP*44, SP*1, 0, new TowerConfig[]{
            ...
            new TowerConfig(SP * 0, SP * 5, SP * 0, new String[][]{
                ...
                new String[]{"623", "622"}, new String[]{"667", "666"}, new String[]{"645", "644"}, new String[]{"591", "1056"}
            }),
            // col 2
            ...
            new TowerConfig(SP * 2, SP * 8, SP * 0, new String[][]{
                new String[]{"565", "672"}, new String[]{"773", "772"}, new String[]{"665", "664"}, new String[]{"811", "810"},
                new String[]{"903", "909"}
            }),
            // col 4
            new TowerConfig(SP * 3, SP * 3, SP * 0, new String[][]{
                new String[]{"905", "955"}, new String[]{"1239", "937"}, new String[]{"942", "930"}, new String[]{"1052", "830"}
            }),
        ...
        new ClusterConfig("CLUSTER_A",SP*24, SP*14, 0, new TowerConfig[] {
            ...
            // col 4
            new TowerConfig(SP * 3, SP * 0, SP * 0, new String[][]{new String[]{"1085", "876"}, new String[]{"473", "472"}, new String[]{"455", "454"}}) // 565n was flickering
        }),
...
//            new TowerConfig(SP * 0, SP * 4, SP * -3, new String[][]{new String[]{"0", "0"}, new String[]{"0", "0"}}),
        ...
        new ClusterConfig("CLUSTER_Z", SP*28, SP*13, 0, new TowerConfig[]{
            ...
            // col 2
            new TowerConfig(SP * 1, SP * 1, SP * -1, new String[][]{new String[]{"1092", "951"}, new String[]{"611", "610"}, new String[]{"653", "652"}}),
            // col 3
            ...
            new TowerConfig(SP * 3, SP * 1, SP * -1, new String[][]{new String[]{"FLASH_803", "1010"}, new String[]{"585", "584"}}) // 867 was flickering
        }),
        ...
        new ClusterConfig("CLUSTER_Y", SP*32, SP*13, 0, new TowerConfig[]{
            ...
            new TowerConfig(SP * 3, SP * 2 - (2 * CUBE_SPACING), SP * 0, 180, 180, 0, new String[][]{new String[]{"FLASH-851", "FLASH-850"}})
        }),
