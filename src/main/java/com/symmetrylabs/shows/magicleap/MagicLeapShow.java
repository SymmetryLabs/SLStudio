...
public class MagicLeapShow extends CubesShow implements Show {
    ...
    static final float globalOffsetX = 51;
    static final float globalOffsetY = 0;
    static final float globalOffsetZ = -25;
    ...
    static final TowerConfig[] TOWER_CONFIG = {
        ...
        new TowerConfig(SP*-2, 0, SP*2, 0, -90, 0, new String[] {"191", "22", "68", "94", "11"}),
        ...
        new TowerConfig(SP*3, 0, SP*2, 0, 0, 0, new String[] {"56", "123", "15", "77", "128"}),
    };
