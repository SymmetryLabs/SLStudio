...
public class StreamingACNDatagram2 extends LXDatagram {
    ...
    public StreamingACNDatagram2(int universeNumber, LXFixture fixture) {
        this(universeNumber, getIndices(fixture));
    }

    private static int[] getIndices(LXFixture fixture) {
     ...
     */
    protected StreamingACNDatagram2(int universeNumber, int dataSize) {
        this(universeNumber, dataSize, null);
    }

    private StreamingACNDatagram2(int universeNumber, int dataSize, int[] pointIndices) {
