...
public class AbsintheShow extends TreeShow {
    ...
    final TwigConfig[] BRANCH = new TwigConfig[]{
        ...
        new TwigConfig(  -9.56f,  24.00f, 0.0f, -54.40f, 0.0f, 0.0f, 6),
        new TwigConfig( -15.36f,  33.60f, 0.0f,  36.00f, 0.0f, 0.0f, 2),
        new TwigConfig(  -8.64f,  44.12f, 0.0f,  39.60f, 0.0f, 0.0f, 3),
        ...
        new TwigConfig(  16.32f,  20.16f, 0.0f, -64.80f, 0.0f, 0.0f, 4),
    };
