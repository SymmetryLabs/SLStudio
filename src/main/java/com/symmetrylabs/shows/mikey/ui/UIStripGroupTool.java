...
import com.symmetrylabs.shows.mikey.StripGroups;
 ...
 */
public class UIStripGroupTool extends UI2dContainer {

    private static final int NUM_GROUPS = StripGroups.NUM_GROUPS;

    public UIStripGroupTool(UI ui, float x, float y, float w) {
        ...
        int[] stripCounts = UIMikeyModelingTool.loadStripCountsFromDisk();
        int totalStrips = 0;
        ...
        UIMikeyModelingTool.MikeyMappingFile mapping = UIMikeyModelingTool.loadFileFromDisk();
