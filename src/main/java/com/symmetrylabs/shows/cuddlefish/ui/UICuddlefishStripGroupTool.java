...
import com.symmetrylabs.shows.cuddlefish.StripGroups;
...
/**
 * GROUPS tab tool. Mirrors the universe/strip layout of UICuddlefishModelingTool
 ...
 *
 * A Save button persists assignments to data/cuddlefish-groups.json so they
 * survive restarts and rebuilds.
 */
public class UICuddlefishStripGroupTool extends UI2dContainer {

    private static final int NUM_GROUPS = StripGroups.NUM_GROUPS;

    public UICuddlefishStripGroupTool(UI ui, float x, float y, float w) {
        ...
        int[] stripCounts = UICuddlefishModelingTool.loadStripCountsFromDisk();
        int totalStrips = 0;
        ...
        UICuddlefishModelingTool.MikeyMappingFile mapping = UICuddlefishModelingTool.loadFileFromDisk();
