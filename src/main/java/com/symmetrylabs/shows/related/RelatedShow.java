package com.symmetrylabs.shows.related;
...
public class RelatedShow extends CubesShow implements HasWorkspace {
    public static final String SHOW_NAME = "relatedshow";
