...
//labeled c1
		new VineConfig("D4",
			new LeafConfig[] {
				...
				new LeafConfig(210, 0, 0, 0, 0, 0),
				new LeafConfig(220, 0, 0, 0, 0, 0),
				new LeafConfig(230, 0, 0, 0, 0, 0),
				new LeafConfig(240, 0, 0, 0, 0, 0),
			}
		),
...
//E429 no data
		...
		new VineConfig("G4",
			new LeafConfig[] {
				new LeafConfig(38.5f, -4, 4.5f, 0, 0, 0),
				new LeafConfig(46.5f, -6.5f, 7, 0, 0, 0),
				new LeafConfig(42, 4, 11, 0, 0, 0),
				new LeafConfig(38.5f, 10, 4, 0, 0, 0),
				new LeafConfig(36, 19, 3, 0, 0, 0),
				new LeafConfig(47, 12, 6, 0, 0, 0),
				new LeafConfig(60.5f, 26, 8, 0, 0, 0),
				new LeafConfig(64.5f, 28, 4.5f, 0, 0, 0),
				new LeafConfig(64.5f, 20.5f, 6, 0, 0, 0),
				new LeafConfig(72.5f, 19.5f, 10, 0, 0, 0),
				new LeafConfig(76.5f, 28.5f, 4.5f, 0, 0, 0),
				new LeafConfig(91, 27, 9, 0, 0, 0),
				new LeafConfig(99, 37, 3.5f, 0, 0, 0),
				new LeafConfig(89, 43.5f, 11, 0, 0, 0),
				new LeafConfig(110, 50, 8, 0, 0, 0),
				new LeafConfig(103, 59, 3.5f, 0, 0, 0),
			}
		),
//added a few leaves
		new VineConfig("H1",
