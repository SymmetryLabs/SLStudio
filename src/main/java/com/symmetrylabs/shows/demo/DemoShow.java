...
public class DemoShow extends CubesShow implements Show {
    ...
    static final float SPACING = 24;

    static final TowerConfig[] TOWER_CONFIG = {
        // group 1
        new TowerConfig(   -SPACING*0.5f,            0, -SPACING*0.5f,    new String[] {"92", "203", "64", "0"}),
            new TowerConfig(SPACING*0.5f, SPACING*0.5f, -SPACING*1.0f,    new String[] {"92", "203", "64", "0"}),
        new TowerConfig(    SPACING*1.0f,            0, -SPACING*2.0f, new String[] {"92", "203", "64", "0"}),
            new TowerConfig(SPACING*2.0f, SPACING*0.5f, -SPACING*2.5f,    new String[] {"92", "203", "64", "0"}),
        new TowerConfig(SPACING*1.5f, 0, -SPACING*3.5f,    new String[] {"92", "203", "64"}),
        new TowerConfig(SPACING*2.5f, SPACING*0.5f, -SPACING*4.0f,    new String[] {"92", "203", "64"}),
        new TowerConfig(SPACING*3.0f, 0, -SPACING*3.0f,    new String[] {"92", "203", "64", "0"}),
        // new TowerConfig(    SPACING*2.5f,            0, -SPACING*3.5f,    new String[] {"92", "203", "64", "0"}),

        new TowerConfig(   -SPACING*1.0f, SPACING*0.5f, -SPACING*1.5f,    new String[] {"92", "203", "64"}),
        new TowerConfig(   -SPACING*0.5f,            0, -SPACING*2.5f,    new String[] {"92", "203", "64"}),
        new TowerConfig(    SPACING*0.5f, SPACING*0.5f, -SPACING*3.0f,    new String[] {"92", "203", "64"}),


        //new TowerConfig(    SPACING*0.5f,            0, -SPACING*4.0f,    new String[] {"92", "203", "64", "0"}),
       // new TowerConfig(    SPACING*1.5f, SPACING*0.5f, -SPACING*4.0f,    new String[] {"92", "203", "64"}),
