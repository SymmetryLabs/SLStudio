package com.symmetrylabs.shows.intel;
 ...
 */
public class IntelShow extends CubesShow implements Show, HasWorkspace {
public static final String SHOW_NAME = "intel";
    ...
    static final TowerConfig[] TOWER_CONFIG = {
        ...
        */
        // A1
        new TowerConfig(CubesModel.Cube.Type.HD, SP*-1.75f, 0, SP*-1.5f, new String[] {"520","876"}),
        // A2
        new TowerConfig(CubesModel.Cube.Type.HD, SP*-0.75f, 0, SP*-2.5f, new String[] {"1210","1211"}),
        // A3
        new TowerConfig(CubesModel.Cube.Type.HD, SP*-0.75f, 0, SP*-1.5f, new String[] {"996","997"}),
        // A4
        new TowerConfig(CubesModel.Cube.Type.HD, SP*-0.75f, 0, SP*-0.5f, new String[] {"999","935"}),
        // A5
        new TowerConfig(CubesModel.Cube.Type.HD, SP*12f+9, 0, SP*-2.5f, new String[] {"594","1231"}),
        // A6
        new TowerConfig(CubesModel.Cube.Type.HD, SP*12.5f+3, 0, SP*-1.5f, new String[] {"1018","1104"}),
        // A7
        new TowerConfig(CubesModel.Cube.Type.HD, SP*12f+9, 0, SP*-0.5f, new String[] {"830","1052"}),
...
//            lx.engine.crossfader.setValue(1);
    ...
    public void setupUi(SLStudioLX lx, SLStudioLX.UI ui) {
      super.setupUi(lx, ui);
        ...
        workspace = new Workspace(lx, ui, "shows/intel");
