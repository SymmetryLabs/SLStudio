    ...
    public Sun9BackBottomPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
        ...
        pixlite.addChild(new PixliteOutput(lx, ipAddress,
            new PointsGrouping("1")
                // .addPoints(slice.getStripById("1").points,  com.symmetrylabs.pixlites.PointsGrouping.REVERSE_ORDERING)
                // .addPoints(slice.getStripById("2").points,  com.symmetrylabs.pixlites.PointsGrouping.Shift.LEFT)
