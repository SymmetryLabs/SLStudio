...
public class Sun8BackTopPixliteConfig {
    public Sun8BackTopPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
        ...
        //   new com.symmetrylabs.pixlites.PointsGrouping("7")
        //     .addPoints(slice.getStripById("37").points, com.symmetrylabs.pixlites.PointsGrouping.REVERSE_ORDERING)
        //     .addPoints(slice.getStripById("38").points)
        //     .addPoints(slice.getStripById("39").points, com.symmetrylabs.pixlites.PointsGrouping.REVERSE_ORDERING)
