 ...
 */
public class Sun6BackTopPixliteConfig {
    public Sun6BackTopPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
        ...
        // pixlite.addChild(new com.symmetrylabs.pixlites.PixliteOutput(lx, ipAddress,
        //   new com.symmetrylabs.pixlites.PointsGrouping("4")
        //     .addPoints(slice.getStripById("24").points, com.symmetrylabs.pixlites.PointsGrouping.REVERSE_ORDERING)
        //     .addPoints(slice.getStripById("25").points)
        //     .addPoints(slice.getStripById("26").points, com.symmetrylabs.pixlites.PointsGrouping.REVERSE_ORDERING)
        //     .addPoints(slice.getStripById("27").points)
        //     .addPoints(slice.getStripById("28").points, com.symmetrylabs.pixlites.PointsGrouping.REVERSE_ORDERING)
        // ));
