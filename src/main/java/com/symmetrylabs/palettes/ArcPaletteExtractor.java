package com.symmetrylabs.palettes;// The com.symmetrylabs.palettes.ColorPalette interface and various implementations that generate or
// extract palettes for use in generative patterns.  (It would have been
// named simply com.symmetrylabs.pattern.Palette, but there is already a com.symmetrylabs.pattern.Palette class in Patterns.pde.)
