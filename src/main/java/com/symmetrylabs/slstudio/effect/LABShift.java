...
public class LABShift extends LXEffect {
    public final CompoundParameter L = new CompoundParameter("L", 0, -100, 100);
    public final CompoundParameter A = new CompoundParameter("A", 0, -100, 100);
    public final CompoundParameter B = new CompoundParameter("B", 0, -100, 100);
    ...
    public void run(double deltaMs, double amount) {
        for (LXPoint p : model.points) {
            ...
            int r = (c & LXColor.RED_MASK) >>> LXColor.RED_SHIFT;
            int g = (c & LXColor.GREEN_MASK) >>> LXColor.GREEN_SHIFT;
            int b = c & LXColor.BLUE_MASK;
            ...
            lab[0] = Math.max(Math.min(lab[0], 100), -100);
