...
public class DaughtryRaindrops extends SLPattern {

 CompoundParameter numRainDrops = new CompoundParameter("NUM", -40, -500, -5);
 CompoundParameter size = new CompoundParameter("SIZE", 0.35, 0.01, 1.0);
 CompoundParameter speedP = new CompoundParameter("SPD", -1000, -7000, -300);
 CompoundParameter speedV = new CompoundParameter("SPDVr");
 CompoundParameter hueV = new CompoundParameter("HUE", 0.5);

    LXVector randomVector() {
        return new LXVector(
    ...
    class Raindrop {
        ...
        Raindrop() {
            ...
            this.speed = abs(speedP.getValuef()) + (random(5000) * speedV.getValuef());
        }
    ...
    public DaughtryRaindrops(LX lx) {
        super(lx);
