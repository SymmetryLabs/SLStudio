...
public class StripPlaySlower extends CubesPattern {
    ...
    private CompoundParameter xSpeed = new CompoundParameter("xSpeed", 2000, 1, MAX_PERIOD);
    private CompoundParameter ySpeed = new CompoundParameter("ySpeed", 1600, 1, MAX_PERIOD);
    private CompoundParameter zSpeed = new CompoundParameter("zSpeed", 1000, 1, MAX_PERIOD);
