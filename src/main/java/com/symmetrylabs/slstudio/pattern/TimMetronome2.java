...
public class TimMetronome2 extends LXPattern {
    ...
    public void run(double deltaMs) {
        ...
        projection.reset();
        projection.translateCenter(model.xMax, model.yMax, model.cz);
        projection.rotate(phase * 0.5f * PI *-1, 0, 0, 1);
