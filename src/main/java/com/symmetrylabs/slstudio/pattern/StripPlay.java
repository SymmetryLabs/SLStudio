package com.symmetrylabs.layouts.patterns;
...
public class StripPlay extends SLPattern<StripsModel<Strip>> {
    ...
    public void run(double deltaMs) {
        ...
        List<Strip> strips = (List<Strip>)((StripsModel)model).getStrips();
