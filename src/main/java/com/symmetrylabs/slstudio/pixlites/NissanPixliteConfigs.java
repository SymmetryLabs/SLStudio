    ...
    public static NissanPixlite[] setupPixlites(LX lx) {
        ...
        return new NissanPixlite[] {
            ...
            new NissanPixlite(lx, "10.200.1.6")
                ...
                .addPoints(model.getStripById("car1-driver-side-front-strip5").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip6").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip7").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip8").getPoints())
            )
                .addPixliteOutput(new PointsGrouping("2") // <- output index on pixlite
                .addPoints(model.getStripById("car1-driver-side-front-strip9").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip10").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip11").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip12").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip13").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip14").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip15").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip16").getPoints())
            )
                .addPixliteOutput(new PointsGrouping("3") // <- output index on pixlite
                .addPoints(model.getStripById("car1-driver-side-front-strip17").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip18").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip19").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip20").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip21").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip22").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip23").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-driver-side-front-strip24").getPoints())
                .addPoints(model.getStripById("car1-driver-side-front-strip25").getPoints(), PointsGrouping.REVERSE_ORDERING)
            )
            ...
            new NissanPixlite(lx, "10.200.1.5")
                // don't forget strips start at the bottom of windows
                .addPixliteOutput(new PointsGrouping("1") // <- output index on pixlite
                .addPoints(model.getStripById("car1-passenger-side-front-strip1").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip2").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip3").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip4").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip5").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip6").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip7").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip8").getPoints())
            )
                .addPixliteOutput(new PointsGrouping("2") // <- output index on pixlite
                .addPoints(model.getStripById("car1-passenger-side-front-strip9").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip10").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip11").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip12").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip13").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip14").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip15").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip16").getPoints())
...
//                    .addPoints(model.getStripById("car1-passenger-side-front-strip18").getPoints())
                ...
                .addPoints(model.getStripById("car1-passenger-side-front-strip17").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip18").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip19").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip20").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip21").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip22").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip23").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-passenger-side-front-strip24").getPoints())
                .addPoints(model.getStripById("car1-passenger-side-front-strip25").getPoints(), PointsGrouping.REVERSE_ORDERING)
...
//
                ...
                .addPoints(model.getStripById("car1-windshield-strip27").getPoints())
                .addPoints(model.getStripById("car1-windshield-strip28").getPoints(), PointsGrouping.REVERSE_ORDERING)
                .addPoints(model.getStripById("car1-windshield-strip29").getPoints())
                .addPoints(model.getStripById("car1-windshield-strip30").getPoints(), PointsGrouping.REVERSE_ORDERING)
            )
//
...
//                .addPoints(model.getStripById("car1-windshield-strip48").getPoints())
//                .addPoints(model.getStripById("car1-windshield-strip49").getPoints(), PointsGrouping.REVERSE_ORDERING)
