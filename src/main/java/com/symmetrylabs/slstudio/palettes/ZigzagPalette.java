 ...
 * forward order from 0 to 1, then reverse order from 1 to 2, then forward order from 2 to 3, etc. Provides several
 * mutable parameters: bottom, top, bias, shift, and cutoff.
 */
public class ZigzagPalette implements ColorPalette {
    ...
    /**
     * The bias factor shifts the output more toward the top end or the bottom end of the palette, while keeping the top
     * and bottom ends in place. A bias of -5 causes the output to spend most of its time (from p = 0 to about p = 0.95)
     * near the bottom end, then shoot quickly up to the top. A bias of +5 causes the output to shoot quickly up to 0.95
     * of the way toward the top end and then spend most of its time near the top end.
     */
