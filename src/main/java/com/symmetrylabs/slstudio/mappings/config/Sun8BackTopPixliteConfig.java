...
public class Sun8BackTopPixliteConfig {
    public Sun8BackTopPixliteConfig(LX lx, Slice slice, Pixlite pixlite) {
        ...
        //   new com.symmetrylabs.slstudio.pixlites.PointsGrouping("7")
        //     .addPoints(slice.getStripById("37").points, com.symmetrylabs.slstudio.pixlites.PointsGrouping.REVERSE_ORDERING)
        //     .addPoints(slice.getStripById("38").points)
        //     .addPoints(slice.getStripById("39").points, com.symmetrylabs.slstudio.pixlites.PointsGrouping.REVERSE_ORDERING)
        ...
        pixlite.addPointsGroup(new PointsGrouping("10")
                .addPoints(
                    slice.getStripById("49").points,
                    PointsGrouping.REVERSE_ORDERING,
                    PointsGrouping.Shift.RIGHT
                ) // more left?
            ...
            .addPoints(slice.getStripById("52").points, PointsGrouping.Shift.LEFT_TWICE) // more left?
        );
