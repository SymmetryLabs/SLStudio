...
public class CubesLayout {
    ...
    static final TowerConfig[] TOWER_CONFIG = {
            ...
            // left
            new TowerConfig(-SP*3.5f, 0, -SP*2.5f, new String[] {
                "22", "204"
                }),

            new TowerConfig(-SP*4.5f, (JUMP*0)+TOWER_RISER, -SP*3.0f, new String[] {
                "86"
                }),

            new TowerConfig(-SP*5.5f, (JUMP*0)+0, -SP*3.5f, new String[] {
                "5"
                }),

         new TowerConfig(-SP*2.0f, 0, -SP*1.0f, new String[] {
                "25", "199", "177"
                }),

         new TowerConfig(-SP*1.5f, (JUMP*0)+TOWER_RISER, -SP*2.0f, new String[] {
                "94"
                }),

         new TowerConfig(-SP*1.0f, (JUMP*0)+TOWER_RISER, -SP*0.5f, new String[] {
                "90"
                }),

         new TowerConfig(-SP*1.0f, (JUMP*2)+TOWER_RISER, -SP*0.5f, new String[] {
                "64"
                }),
