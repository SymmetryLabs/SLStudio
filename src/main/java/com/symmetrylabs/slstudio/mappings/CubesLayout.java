...
public class CubesLayout {
    ...
    static final TowerConfig[] TOWER_CONFIG = {
        ...
        //1
        new TowerConfig(-2*SP, 0, -2*SP, 0, 0, 0, new String[] {
            "21", "335", "343",
        }),
        //2
        new TowerConfig(-1*SP, 0, -1*SP, 0, 0, 0, new String[] {
            "63", "202", "33"}),
        //3 (3rd from left)
        new TowerConfig(0, 0, 0, 0, 0, 0, new String[] {
            "2", "40", "199"}),
        //4
        new TowerConfig(SP*1, 0, SP*1, 0, 0, 0, new String[] {
            "314", "337", "26"}),
        //5
        new TowerConfig(SP*1, 0, SP*3, 0, -90, 0, new String[] {
            "39", "126", "111",}),
        //6
        new TowerConfig(SP*0, 0, SP*2, 0, -90, 0, new String[] {
            "11", "94", "120",}),
        ////7
        new TowerConfig(-SP*1, 0, SP*1, 0, -90, 0, new String[] {
            "171", "138", "131"}),
        //8

        new TowerConfig(-SP*2, 0, SP*0, 0, -90, 0, new String[] {"27", "9", "85"})
    };
