...
public class Sun6BackTopPixliteConfig {
    public Sun6BackTopPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
        ...
        //     .addPoints(slice.getStripById("26").points, com.symmetrylabs.slstudio.pixlites.PointsGrouping.REVERSE_ORDERING)
        //     .addPoints(slice.getStripById("27").points)
        //     .addPoints(slice.getStripById("28").points, com.symmetrylabs.slstudio.pixlites.PointsGrouping.REVERSE_ORDERING)
        // ));
