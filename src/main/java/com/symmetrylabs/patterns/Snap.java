...
public class Snap extends LXPattern {
    private final List<LXVector> particles = new ArrayList<>();
    private final List<LXVector> destinations = new ArrayList<>();
    private final List<Float> spreads = new ArrayList<>();
