...
public abstract class UIClipLauncher extends UI2dContainer {
    ...
    protected final List<UIClipButton> internalClips = new ArrayList<UIClipButton>(NUM_CLIPS);
    public final List<UIClipButton> clips = Collections.unmodifiableList(this.internalClips);
