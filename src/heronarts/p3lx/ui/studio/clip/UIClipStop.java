...
public abstract class UIClipStop extends UI2dComponent implements UIFocus {

    private static final int STOP_BUTTON_WIDTH = 12;

    private boolean stopButtonDown = false;

    protected UIClipStop(UI ui) {
        super(0, 0, UIClipLauncher.WIDTH, UIClipButton.HEIGHT);
