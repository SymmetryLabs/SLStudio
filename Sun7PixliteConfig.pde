...
public class Sun7BackBottomPixliteConfig {
  public Sun7BackBottomPixliteConfig(LX lx, Slice slice, String ipAddress, Pixlite pixlite) throws SocketException {
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("1")
        .addPoints(((SLModel)lx.model).getSliceById("sun7_top_back").getStripById("37").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(((SLModel)lx.model).getSliceById("sun7_top_back").getStripById("38").points)
        .addPoints(((SLModel)lx.model).getSliceById("sun7_top_back").getStripById("39").points, PointsGrouping.REVERSE_ORDERING)
        .addPoints(((SLModel)lx.model).getSliceById("sun7_top_back").getStripById("40").points)
    ));
    ...
    pixlite.addChild(new PixliteOutput(lx, pixlite, ipAddress,
      new PointsGrouping("10")
       .addPoints(slice.getStripById("49").points, PointsGrouping.Shift.LEFT) // more left?
