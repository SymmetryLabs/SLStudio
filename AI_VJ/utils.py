...
#######################################
##    new functions (mid 2018)
######################################

## patterns 1_5
def create_Y_pattern(dataframe, channel, patterns_full=patterns_full):
    pattern_list = []
