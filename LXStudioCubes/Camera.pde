...
public class PhotoBoothCamera extends DPat {
    ...
    private int width  = (int)Math.abs(model.photoBoothCanvas.xMax - model.photoBoothCanvas.xMin);
    private int height = (int)Math.abs(model.photoBoothCanvas.xMax - model.photoBoothCanvas.xMin);
