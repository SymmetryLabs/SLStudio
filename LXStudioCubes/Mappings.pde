 ...
 * VJ Booth
 *---------------------------------------------------------------------------------------------*/
static final float vj_booth_offset_x = 155;
static final float vj_booth_offset_y = 295;
...
static final StripConfig[] VJ_BOOTH_STRIP_CONFIG = {
 ...
 new StripConfig("vj_booth-strip1", new float[] {0, 0, 0}, new float[] {0, 0, 0}, 34),
 new StripConfig("vj_booth-strip2", new float[] {43, 0, 0}, new float[] {0, 0, -90}, 31), // vertical
 new StripConfig("vj_booth-strip3", new float[] {43, -39, 0}, new float[] {0, 0, 0}, 46),

 new StripConfig("vj_booth-strip4", new float[] {0, 0, 0}, new float[] {0, 0, 90}, 7), // tiny part
 new StripConfig("vj_booth-strip5", new float[] {0, 8, 0}, new float[] {0, 0, 0}, 80),
 new StripConfig("vj_booth-strip6", new float[] {100, 8, 0}, new float[] {0, 0, -90}, 38),

 // // next part
 // // horizontals 
 // new StripConfig("vj_booth-strip7", new float[] {0, 14, 0}, new float[] {0, 0, 0}, 91), // bottom

 // // top
 // new StripConfig("vj_booth-strip8", new float[] {0, 14+60, 0}, new float[] {0, 0, 0}, 25), // top
 // new StripConfig("vj_booth-strip9", new float[] {0, 14+60+6, 0}, new float[] {0, 0, 0}, 102), // top 2
